...
path_anno     = './annos/coesot_anno/';                  % path to annotations
path_att      = './annos/att/';               % path to attribute
rp_all        = './coesot_tracking_results/';        % path to tracking results
...
drawAttributeResults = true; %% true, false
    ...
    switch metric_type
        case 'error'
            ...
            if strcmp(evaluation_dataset_type, 'all')
                title_name = [title_name ' on COESOT'];
            else
                title_name = [title_name ' on COESOT Testing Set'];
            end
        case 'overlap'
